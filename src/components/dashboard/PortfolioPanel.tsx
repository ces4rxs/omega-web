...
export const PortfolioPanel: React.FC = () => {
            ...
            <div className="relative rounded-xl border border-gray-800/50 bg-black/40 backdrop-blur-sm p-4 h-full flex flex-col">
                <div className="flex-1 flex items-center justify-center">
                    <div className="text-center space-y-3">
                        <div className="w-12 h-12 mx-auto border-2 border-gray-700 border-t-indigo-500 rounded-full animate-spin opacity-50" />
                        <p className="text-xs text-gray-500 font-mono uppercase tracking-wider">
                            &gt; CONNECTING TO PORTFOLIO ENGINE v21...
                        </p>
                    </div>
                </div>
            </div>
    ...
    // Placeholder when no portfolio data yet
    if (!portfolio) {
        return (
            <div className="relative rounded-xl border border-gray-800/50 bg-black/40 backdrop-blur-sm p-4 h-full flex flex-col">
                <header className="flex items-center justify-between pb-3 border-b border-gray-800/50 mb-4">
                    <div>
                        ...
                        <p className="text-[10px] text-gray-500 font-mono mt-0.5">AI-Driven Optimal Exposure & Correlation</p>
                    </div>
                    <Badge variant="outline" className="font-mono text-[9px] px-2 py-0.5 border-indigo-500/30 text-indigo-400">
                        OFFLINE
                    </Badge>
                </header>
                ...
                <div className="flex-1 flex items-center justify-center">
                    <div className="text-center space-y-2">
                        <Briefcase className="w-8 h-8 mx-auto text-gray-700 animate-pulse" />
                        <p className="text-xs text-gray-600 font-mono uppercase tracking-wider">
                            &gt; WAITING FOR PORTFOLIO_UPDATE_V21...
                        </p>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="relative rounded-xl border border-gray-800/50 bg-black/40 backdrop-blur-sm p-4 space-y-4 shadow-[0_0_30px_rgba(99,102,241,0.05)] h-full flex flex-col overflow-hidden">
            {/* Header */}
            <header className="flex items-center justify-between pb-3 border-b border-gray-800/50 flex-shrink-0">
                ...
                <Badge variant="success" className="font-mono text-[9px] px-2 py-0.5 bg-indigo-500/20 border-indigo-500/30 text-indigo-400">
                    LIVE
                </Badge>
            </header>
                                    ...
                                    >
                                        ...
                                        <div className={`pl-3 pr-3 py-2 rounded-lg ${priorityStyle.bg} border ${priorityStyle.border} hover:bg-white/5 transition-colors`}>
                                            <div className="flex items-start justify-between gap-2 mb-1">
                                                <Badge className={`${priorityStyle.color} bg-black/30 border-current text-[8px] px-1.5 py-0 font-mono font-bold`}>
                                                    {suggestion.priority}
                                                </Badge>
            ...
            <footer className="text-[9px] text-gray-500 font-mono pt-3 border-t border-gray-800/50 flex items-center justify-between flex-shrink-0">
                <span>
                    Last Update: {new Date(portfolio.timestamp).toLocaleTimeString('es-ES', { hour: '2-digit', minute: '2-digit', second: '2-digit' })}
                </span>
                <span className="text-indigo-400">● COMPUTING</span>
            </footer>
        </div>
    )
}
